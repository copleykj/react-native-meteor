...
var Trackr = _interopDefault(require('trackr'));
var EJSON = _interopDefault(require('ejson'));
var EventEmitter = _interopDefault(require('wolfy87-eventemitter'));
var Minimongo = _interopDefault(require('minimongo-cache'));
...
var useTracker = (function (trackerFn) {
  ...
  var _useState = React.useState(trackerFn()),
...
function withTracker(options) {
  return function (Component) {
    ...
    var WithTracker = /*#__PURE__*/React.forwardRef(function (props, ref) {
    ...
    return pure ? /*#__PURE__*/React.memo(WithTracker) : WithTracker;
  };
}
